/*
1) Vamos falar um pouco sobre "Futebol". Escolha um campeonato estadual qualquer
...
/*
2) Declare uma variável chamada `teams`, que receberá um array com 5 elementos.
Os elementos serão nomes de times do campeonato escolhido, e os nomes devem
estar na ordem em que eles aparecem na tabela no momento da solução desse
desafio.
*/
var teams = ['atletico', 'coritiba', 'parana', 'londrina', 'maringa'];

console.log( 'Times que estão participando do campeonato:', teams );

/*
3) Crie uma função chamada `showTeamPosition` com as seguintes características:
...
/*
5) Mostre os números de 20 a 30 no console (inclusive o 30), usando a estrutura de
repetição "while".
*/
var counter = 20;
while(counter <= 30){
...
/*
6) Crie uma função chamada `convertToHex`, com as seguintes características:
...
/*
7) Tente mostrar o hexadecimal de 8 cores diferentes usando a função criada acima.
*/
console.log('\n' + convertToHex('red'));
